...
//map return somethings and for Each don't

//Q36

let data1 = ["aman", "anil ", "naman"];
delete data1[1];
console.log(data1);

//it will make the place empty but lenght will be the same
...
//it has repeating value because in array there can be same value keys but not in object with the same keys
...
//its define the power of 3 isto 3
...
//answer will be 1 because of hoisting and global scope of a123;
...
//57 because every word has different ascii value

// const ducat = document.getElementById("hello").innerHTML;
// console.log(ducat);

function onclicked(){
     var element =document.getElementById("hello").innerHTML;
     console.log(element);
     if(element == "hii"){
        element = "aman";
     }else {
